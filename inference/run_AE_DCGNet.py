"""
DCGNet for Point Set AutoEncoding.
@run_AE_DCGNet.py
"""
...
# =================================== Create Network ====================================== #
network = AE_PointNet_DCGNet(nb_primitives1=opt.nb_primitives1, nb_primitives2=opt.nb_primitives2,
...
with torch.no_grad():
    for i, data in enumerate(dataloader_test, 0):
        ...
        points = points.cuda()
        pointsReconstructed1, pointsReconstructed = network.forward_inference(points, grid)
